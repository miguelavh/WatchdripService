...
export const BG_VALUE_TEXT = {
  ...
  y: DEVICE_HEIGHT - px(20) - px(95)-px(80)-px(60)-px(60),
  w: px(250),
  h: px(95),
  color: Colors.white,
  text_size: px(95),
...
export const BG_TIME_TEXT = {
  x: (DEVICE_WIDTH - px(250)) / 2,
  y: DEVICE_HEIGHT  - px(10) - px(80)-px(60)-px(60),
  w: px(250),
  h: px(40),
  color: Colors.white,
  text_size: px(40),
...
export const BG_TREND_IMAGE = {
  ...
  x: DEVICE_WIDTH - px(75),
  y: DEVICE_HEIGHT  - px(20) - px(85)-px(80)-px(60)-px(60),
  w: px(45),
  h: px(45),
};
...
export const BG_STALE_RECT = {
  ...
  y: DEVICE_HEIGHT  - px(20) - px(85)-px(80)-px(60)-px(60)+px(40),
  w: px(180),
  h: px(5),
  color: Colors.white,
  visible: false,
